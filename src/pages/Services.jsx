...
const Services = () => {
  ...
  return (
    <div className="pt-20 min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-block mb-6 px-6 py-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full backdrop-blur-sm"
            >
              <span className="text-cyan-400 font-semibold">⚕️ Services</span>
            </motion.div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent tracking-tight">
              Services & Expertise
            </h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-cyan-400 mb-6 text-center">{service.title}</h3>
      ...
      <section className="py-20 bg-transparent">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-white">Professional Competencies</h2>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {competencies.map((comp, index) => (
              <motion.div
                ...
                className="glass-card rounded-2xl p-8"
              >
                <h3 className="text-2xl font-bold text-teal-400 mb-6">{comp.category}</h3>
                <ul className="space-y-3">
